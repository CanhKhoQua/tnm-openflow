...
TEAMS_APP_ID = PersistentConfig('TEAMS_APP_ID', 'openflow.teams_app_id', os.environ.get('TEAMS_APP_ID', ''))
TEAMS_APP_SECRET = PersistentConfig(
    'TEAMS_APP_SECRET', 'openflow.teams_app_secret', os.environ.get('TEAMS_APP_SECRET', '')
)
TEAMS_TENANT_ID = PersistentConfig('TEAMS_TENANT_ID', 'openflow.teams_tenant_id', os.environ.get('TEAMS_TENANT_ID', ''))
...
LLM_MODEL = PersistentConfig('LLM_MODEL', 'openflow.llm_model', os.environ.get('LLM_MODEL', 'llama3.2'))
LLM_API_KEY = PersistentConfig('LLM_API_KEY', 'openflow.llm_api_key', os.environ.get('LLM_API_KEY', ''))
